...
//     if (!tour.fixedDepartures) {
//       tour.fixedDepartures = [];
//     }
...
//     if (!tour.fixedDepartures) {
//       return next(createHttpError(404, 'No fixed departures found for this tour'));
//     }
...
//     if (tour.fixedDepartures.length === 0) {
//       tour.fixedDepartures = undefined;
//     }
//     await tour.save();
...
//       if (!tour.fixedDepartures) return [];
